...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-username" data-rule="required" readonly="readonly" class="form-control" name="row[username]" type="text" value="<?php echo htmlentities($row['username']); ?>">
        </div>
    </div>
    <!--<div class="form-group">-->
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-card_id"  readonly="readonly"   class="form-control" name="row[card_id]" type="text" value="<?php echo htmlentities($row['card_id']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Qianfa_start'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-qianfa_start"  readonly="readonly" class="form-control" name="row[qianfa_start]" type="text" value="<?php echo htmlentities($row['qianfa_start']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Qianfa_end'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-qianfa_end"  readonly="readonly" class="form-control" name="row[qianfa_end]" type="text" value="<?php echo htmlentities($row['qianfa_end']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Qianfa_unit'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-qianfa_unit"  readonly="readonly" class="form-control" name="row[qianfa_unit]" type="text" value="<?php echo htmlentities($row['qianfa_unit']); ?>">
        </div>
    </div>
    <div class="form-group">
