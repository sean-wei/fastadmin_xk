...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-description" data-rule="required" class="form-control" name="row[description]" type="text" value=""></textarea>
        </div>
    </div>
    <!--<div class="form-group">-->
    ...
    <div class="form-group">
        ...
        <!--</div>-->
        <input  id="c-category" name="row[category]" type="hidden" value="news">
