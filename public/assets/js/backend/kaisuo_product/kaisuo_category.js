define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'kaisuo_category/index' + location.search,
                    add_url: 'kaisuo_category/add',
                    edit_url: 'kaisuo_category/edit',
                    del_url: 'kaisuo_category/del',
                    multi_url: 'kaisuo_category/multi',
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'kaisuo_category/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
