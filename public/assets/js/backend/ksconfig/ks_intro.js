define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'ksconfig/ks_intro/index' + location.search,
                    add_url: 'ksconfig/ks_intro/add',
                    edit_url: 'ksconfig/ks_intro/edit',
                    del_url: 'ksconfig/ks_intro/del',
                    multi_url: 'ksconfig/ks_intro/multi',
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'ksconfig/ks_intro/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
