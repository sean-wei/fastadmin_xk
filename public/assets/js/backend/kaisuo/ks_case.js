define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'kaisuo/ks_case/index' + location.search,
                    add_url: 'kaisuo/ks_case/add',
                    edit_url: 'kaisuo/ks_case/edit',
                    del_url: 'kaisuo/ks_case/del',
                    multi_url: 'kaisuo/ks_case/multi',
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'kaisuo/ks_case/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
